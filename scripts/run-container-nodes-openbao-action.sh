...
[[ $# -eq 1 ]] || { echo "usage: run-container-nodes-openbao-action.sh prepare-applications|provision-secrets|verify" >&2; exit 2; }
case "$1" in
  prepare-applications|provision-secrets|verify) ;;
